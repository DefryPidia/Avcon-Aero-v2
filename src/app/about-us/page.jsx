    ...
    <div>
      ...
      <div className="container-fluid px-0">
        ...
        <div className="container col-md-10 my-5">
          <h2 className="display-6 fw-bold mb-1 aero-blue text-uppercase">The Purpose</h2>
          <p className="text-justify">
        ...
        <div className="container col-md-10 my-5">
          <h2 className="display-6 fw-bold mb-1 aero-blue text-uppercase">Aerospace aftermarket specialists</h2>
          <p className="text-justify">
